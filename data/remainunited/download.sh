...
cat generated/example_postcodes.csv | while read line; do
  ...
  curl 'https://www.remainunited.org/' --data "form_type=postcode-search&hid_form=Postcode+Search+Form&action=search&f_search_text_postcode=${pcode}&submit=submit" >| "data/remainunited/response/${slug}.html"
