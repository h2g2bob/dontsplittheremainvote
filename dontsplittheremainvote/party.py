...
ANNASOUBRY = Party('Anna Soubry', remain=True, color='#e7e7e7', short='ind')
DAFYDD = Party('Aled ap Dafydd', remain=True, color='#e7e7e7', short='ind')
...
MARTINGOSS = Party('Martin Goss', remain=True, color='#e7e7e7', short='ind')
PAULFOLLOWS = Party('Paul Follows', remain=True, color='#e7e7e7', short='ind')
VIXLOWTHION = Party('Vix Lowthion', remain=True, color='#e7e7e7', short='ind')
